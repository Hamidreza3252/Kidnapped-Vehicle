                                   ...
                                   const Map &map)
{
  ...
  {
    double landmark_distance = dist(best_particle_.x, best_particle_.y, map_landmark.x, map_landmark.y);

    if (landmark_distance > sensor_range + 5.0)
    {
      continue;
    }
